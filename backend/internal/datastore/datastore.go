...
func (ds *DataStore) ClientSettings() ClientSettingsRepository { return &pgClientSettingsRepo{pool: ds.pool} }
...
func (ds *DataStore) PlaybackProgress() PlaybackProgressRepository { return &pgPlaybackProgressRepo{pool: ds.pool} }
func (ds *DataStore) ContentPreferences() ContentPreferencesRepository { return &pgContentPrefsRepo{pool: ds.pool} }
...
func (t *Tx) PlaybackProgress() PlaybackProgressRepository { return &pgPlaybackProgressRepo{pool: t.tx} }
func (t *Tx) ContentPreferences() ContentPreferencesRepository { return &pgContentPrefsRepo{pool: t.tx} }
